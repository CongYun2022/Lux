...
void Game::AddPlane(APlane* plane)
{
	mPlanes.emplace_back(plane);
}

void Game::RemovePlane(APlane* plane)
{
...
void Game::ProcessInput()
{
	...
	if (mGameState == EGameplay)
	{
		...
		{
			if (actor->GetState() == AActor::EActive)
			{
...
void Game::UpdateGame()
{
	...
	if (mGameState == EGameplay)
	{
		...
		std::vector<AActor*> deadActors;
		for (auto actor : mActors)
		{
			if (actor->GetState() == AActor::EDead)
			{
...
void Game::AddActor(AActor* actor)
{
...
void Game::RemoveActor(AActor* actor)
{
