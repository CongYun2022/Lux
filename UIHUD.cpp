...
void UIHUD::AddTargetComponent(CTarget* tc)
{
	mTargetComps.emplace_back(tc);
}

void UIHUD::RemoveTargetComponent(CTarget* tc)
{
...
void UIHUD::UpdateCrosshair(float deltaTime)
{
...
void UIHUD::UpdateRadar(float deltaTime)
{
