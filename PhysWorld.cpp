...
void PhysWorld::TestPairwise(std::function<void(AActor*, AActor*)> f)
{
...
void PhysWorld::TestSweepAndPrune(std::function<void(AActor*, AActor*)> f)
{
	// Sort by min.x
...
void PhysWorld::AddBox(CBox* box)
{
	mBoxes.emplace_back(box);
}

void PhysWorld::RemoveBox(CBox* box)
{
